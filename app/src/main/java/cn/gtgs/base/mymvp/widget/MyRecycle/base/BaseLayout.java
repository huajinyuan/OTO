package cn.gtgs.base.mymvp.widget.MyRecycle.base;
...
import cn.gtgs.base.mymvp.utils.F;
...
public abstract class BaseLayout extends LinearLayout
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch(action){
            ...
            case MotionEvent.ACTION_MOVE:{
                ...
                if(standView == null){
                   ...
                   F.e("absDiff = "+absDiff + "/ mTouchSlop = "+mTouchSlop + "/ diff = "+diff);
       ...
       F.w("Whether to intercept----->"+mIsBeingDragged);
    ...
    public void setPullRefreshEnable(boolean enable){
       F.w("SET REFRESHABLE ---->"+enable);
        isPullRefreshEnable = enable;
    }

    public void setPullLoadEnable(boolean enable){
       F.w("SET LOADABLE ---->"+enable);
        ...
        try{
            if(isPullLoadEnable)
            {
                if(loaderView != null)
                {
                    ...
                    F.i("LoaderView sliding time ---->"+duration);
...
//                        setPullLoadEnable(false);
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
       ...
       F.d("isNest = "+isNest + "/ orientation = "+orientation + "/ isNestConfilct = "+isNestConfilct);
       F.w("Whether to allow nested sliding--->"+(isAllowNest? "yes":"no"));
    ...
    public void onStopNestedScroll(View child) {
       ...
       F.d("Callback--->onStopNestedScroll----state = "+state);
        mNestedScrollingParentHelper.onStopNestedScroll(child);

        if(state == CONTENT_VIEW_STATE.PUSH && !isRefreshing && !isLoadingMore){
           F.d("Processing PUSH results");
            handlePushNestStop();
        }
